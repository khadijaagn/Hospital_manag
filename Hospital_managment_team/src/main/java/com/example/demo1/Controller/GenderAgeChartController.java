...
import com.example.demo1.Model.GenderAgeModel;
...
public class GenderAgeChartController {
    ...
    private GenderAgeModel genderAgeModel;

    @FXML
    public void initialize() {
        // Initialiser le modèle
        genderAgeModel = new GenderAgeModel();
