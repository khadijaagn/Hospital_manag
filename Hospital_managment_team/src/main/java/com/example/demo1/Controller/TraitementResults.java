...
import com.example.demo1.Model.Test_traitResultModel;
...
public class TraitementResults {
    ...
    // Instance du modèle
    private final Test_traitResultModel testResultModel = new Test_traitResultModel();
